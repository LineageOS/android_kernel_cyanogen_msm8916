...
static void wcd_program_btn_threshold(const struct wcd_mbhc *mbhc, bool micbias)
{
	...
	snd_soc_update_bits(codec, MSM8X16_WCD_A_ANALOG_MBHC_BTN1_ZDETH_CTL, 0xFC, 0x68);
	snd_soc_update_bits(codec, MSM8X16_WCD_A_ANALOG_MBHC_BTN2_ZDETM_CTL, 0xFC, 0x40);
